...
// Базовый запрос для личных рецептов
$query = "
...
if (!empty($searchQuery)) {
    $query .= " AND (r.recipe_name LIKE :search OR r.description LIKE :search)";
...
// Получаем рецепты
$recipes = fetchRecipes($pdo, $query, $params);
    ...
    <aside class="sidebar">
      ...
      <nav class="main-nav">
        <ul>
          ...
          <li><a href="search.php"><i class="material-icons">search</i> Поиск рецептов</a></li>
          ...
          <li><a href="favorites.php"><i class="material-icons">favorite</i> Избранное</a></li>
        ...
        <div class="header-actions">
          <form method="GET" action="home.php" class="search-form">
            ...
            <?php if (!empty($searchQuery) || !empty($categoryFilter)): ?>
              <a href="home.php" class="btn-clear">Сбросить</a>
            <?php endif; ?>
          </form>
          <a href="add_recipe.php" class="btn btn-primary">
            <i class="material-icons">add</i> Новый рецепт
          </a>
        </div>
      </header>
            ...
            <div class="recipe-card">
              ...
              <div class="recipe-body">
                ...
                <div class="recipe-meta">
                  <span><i class="material-icons">access_time</i> <?= $recipe['prep_time'] + $recipe['cook_time'] ?> мин</span>
                ...
                <div class="recipe-actions">
                  ...
                  <a href="edit_recipe.php?id=<?= $recipe['recipe_id'] ?>" class="btn btn-edit"><i class="material-icons">edit</i></a>
                </div>
              </div>
            </div>
          <?php endforeach; ?>
        <?php else: ?>
          <div class="empty-state">
            ...
            <?php if (!empty($searchQuery)): ?>
              <a href="home.php" class="btn btn-secondary">Показать все рецепты</a>
            <?php endif; ?>
          </div>
        <?php endif; ?>
      </div>
